...
;// CONCATENATED MODULE: ./src/blocks/modules/header/header.js
if (document.querySelector(".header__button")) {
    document
        ...
        .addEventListener("click", function (e) {
            ...
            newSvg.classList.add("icon-box");

            // Создаем элемент "use" внутри SVG
            var useElement = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "use"
            );

            if (document.querySelector(".header__button.active")) {
                useElement.setAttribute("href", "img/icons/icons.svg#Vector");
                document
                    .querySelector(".header__button")
                ...
                if (window.innerWidth <= 767) {
                    useElement.setAttribute(
                        "href",
                        "img/icons/icons.svg#ion_stats-chart-arrow"
                    );
                } else {
                    useElement.setAttribute(
                        "href",
                        "img/icons/icons.svg#arrow"
                    );
                }
            ...
            // Добавляем "use" внутрь SVG
            newSvg.appendChild(useElement);

            // Находим элемент, который вы хотите заменить
            var targetElement = document.querySelector(".header__button svg");

            // Заменяем элемент новым SVG-фрагментом
            targetElement.parentNode.replaceChild(newSvg, targetElement);
        });
}
if (document.querySelector(".header__search-mob")) {
    document
...
function initSliders() {
    ...
    if (document.querySelector(".popular__slider")) {
        ...
        function initializeSwiper() {
            ...
            if (screenWidth > 768) {
                ...
                popular = new core(".popular__slider", {
                    // Вказуємо склас потрібного слайдера
    ...
    if (document.querySelector(".catalog__slider")) {
        // Вказуємо склас потрібного слайдера
        // Створюємо слайдер
        let product = new core(".catalog__slider", {
            // Вказуємо склас потрібного слайдера
    ...
    if (document.querySelector(".similar__slider")) {
        let product = new core(".similar__slider", {
            modules: [Navigation, Pagination],
            //loop: true,
    ...
    if (document.querySelector(".productwan__slider")) {
        var productZoom = new core(".productwan__slider", {
            modules: [Thumb],
            spaceBetween: 17,
            slidesPerView: 5,
            freeMode: true,
    ...
    if (document.querySelector(".productwan__thumbs")) {
        var productZoomThumbsslider = new core(".productwan__thumbs", {
            cssMode: true,
            spaceBetween: 0,
            modules: [Thumb],
            thumbs: {
...
;// CONCATENATED MODULE: ./src/js/libs/rangeslider.js
...
;// CONCATENATED MODULE: ./src/js/functions/stepper.js
...
//import "../blocks/components/popup/popup.js";
//збыльшення картки товара
//import { zoom } from "./functions/zoom.js";
//zoom();
//додавання кількості товару

stepper();
//перемикання відображення товарів
//import { toggleLarge } from "./functions/toggle-large.js";
//toggleLarge();

// import { menuFilter } from "./functions/menu-filter.js";
// menuFilter();
// import "./functions/select.js";
// import "./functions/account-nav.js";

//import "../js/functions/slick-product.js";
//import "../blocks/components/tabs/tabs.js";
// import { countdown } from "./functions/countdown.js";
// countdown();
// import { formRating } from "./functions/rating.js";
// formRating();
document.addEventListener("DOMContentLoaded", function () {
    var accordionItems = document.querySelectorAll(".accordions__item");

    accordionItems.forEach(function (item) {
        var header = item.querySelector("[data-accordion]");
        var content = item.querySelector(".accordions__body");
...
document.addEventListener("DOMContentLoaded", function () {
    var customSelect = document.querySelector(".catalog__select");
    var selectSelected = document.querySelector(".catalog__selected");
    var selectItems = document.querySelector(".catalog__items");
    if (selectItems) {
        selectSelected.addEventListener("click", function () {
            selectItems.style.display =
                selectItems.style.display === "flex" ? "none" : "flex";
        });
...
document.addEventListener("DOMContentLoaded", function () {
    var customSelect = document.querySelector(".filter__button");
    var customContent = document.querySelector(".filter__content");
    var filterContent = document.querySelector(".filter");
    if (customSelect) {
        customSelect.addEventListener("click", function () {
            customContent.classList.toggle("active");
...
if (document.querySelector(".filter__button")) {
    document
        ...
        .addEventListener("click", function (e) {
            ...
            if (document.querySelector(".filter__button.active")) {
                useElement.setAttribute(
                    "href",
                    "img/icons/icons.svg#ion_stats-chart-sharp"
                );
            } else {
                useElement.setAttribute(
                    "href",
            ...
            // Находим элемент, который вы хотите заменить
            var targetElement = document.querySelector(".filter__button svg");
...
function moveElement() {
    var containers = document.querySelectorAll(".catalog__card");

    containers.forEach(function (container) {
        var blocks = container.querySelector(".product__rating");

        var elements = container.querySelectorAll(".catalog__card-img");
...
if (document.querySelector(".tabs-container")) {
    document.addEventListener("click", function (event) {
        // Проверяем, что клик был по элементу с классом "tab"
        if (event.target.classList.contains("tab")) {
            ...
            // Скрыть все содержимое и снять активные классы
            document
            ...
            // Отобразить содержимое выбранной вкладки и добавить активные классы
            document
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var selectSelected = document.querySelector(".order__selected");
    var btnSelected = document.querySelector(".order__btn");
    var selectItems = document.querySelector(".order__items");
    if (selectItems) {
...
if (document.querySelector("#orderForm")) {
        ...
        .addEventListener("submit", function (event) {
            ...
            if (!isValidPhone(phone)) {
                document.getElementById("phoneError").textContent =
                    "Введите корректный телефон (10 цифр)";
                isValid = false;
            } else {
                document.getElementById("phoneError").textContent = "";
            }
            ...
            // Проверка чекбокса
            var agree = document.getElementById("check_2").checked;
            if (!agree) {
    ...
    function isValidPhone(phone) {
        // Регулярное выражение для проверки телефона (10 цифр)
        var phoneRegex = /^\d{10}$/;
...
/////////////////////////////////////////////////////$RECYCLE.BIN
document.addEventListener("DOMContentLoaded", function () {
    var accordionItems = document.querySelectorAll(".faq__accordion-item");

    accordionItems.forEach(function (item) {
        var header = item.querySelector(".faq__accordion-title");
        var content = item.querySelector(".faq__accordion-body");
...
/////////////////////////////////////////////////////////////$RECYCLE.BIN
///////////////////////////////////minecraft-fabric-optifine
if (document.querySelector("#order__ymap")) {
    function init() {
        var myMap = new ymaps.Map("order__ymap", {
            center: [55.6775438, 37.5558909],
            zoom: 15,
        ...
        var myPlacemarks = [
            {
                coordinates: [55.6575438, 37.5558909],
                hintContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
                balloonContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
            },
            {
                coordinates: [55.1775438, 37.5558909],
                hintContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
                balloonContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
            ...
            {
                coordinates: [55.2775438, 37.5558909],
                hintContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
                balloonContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
            ...
            {
                coordinates: [55.5775438, 37.5558909],
                hintContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
                balloonContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
            ...
            {
                coordinates: [55.6075438, 37.5558909],
                hintContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
                balloonContent:
                    "Магазин «Русклимат» в выставочном комплексе «Экспострой на Нахимовском»",
            ...
            // Добавьте здесь другие метки
        ];

        // Добавляем метки на карту
        for (var i = 0; i < myPlacemarks.length; i++) {
            var placemark = new ymaps.Placemark(
                myPlacemarks[i].coordinates,
                {
                    hintContent: myPlacemarks[i].hintContent,
                    balloonContent: myPlacemarks[i].balloonContent,
                    iconCaption: myPlacemarks[i].iconCaption,
                },
                {
                    iconLayout: "default#image",
                    iconImageHref: "img/icons/ph_map-pin-fill.svg",
                    iconImageSize: [46, 46],
        ...
        // Перемещаем карту к меткам при клике на список
        var listItems = document.querySelectorAll(".order__maps-list li");
        for (var i = 0; i < listItems.length; i++) {
            listItems[i].addEventListener("click", function () {
                var index = this.getAttribute("data-index");
                var coordinates = myPlacemarks[index].coordinates;
...
if (document.querySelector("#contact__ymap")) {
    function init() {
        var myMap = new ymaps.Map("contact__ymap", {
            center: [55.6775438, 37.5558909],
            zoom: 15,
            behaviors: ["scrollZoom", "drag"],
        });
        ...
        // Перемещаем карту к меткам при клике на список
        var listItems = document.querySelectorAll(".contact__maps-list li");
        for (var i = 0; i < listItems.length; i++) {
            listItems[i].addEventListener("click", function () {
                var index = this.getAttribute("data-index");
                var coordinates = myPlacemarks[index].coordinates;
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [532], () => (__webpack_require__(822)))
